(function (h, e) {
          ...
          onTap: function (a) {
            ...
            c
              ...
              : (g.requestFullscreen && g.requestFullscreen(),
                ...
                g.requestFullscreen&&
                  g.requestFullscreen(Element.ALLOW_KEYBOARD_INPUT),
                (c = !0));
  ...
  n.prototype = Object.assign(Object.create(e.Mesh.prototype), {
   ...
   getZoomLevel: function () {
    const maxZoomLevel = 0; // Establece el nivel de zoom máximo permitido

    let zoomLevel;
    if (800 >= window.innerWidth) {
        zoomLevel = this.ImageQualityFair;
    } else if (800 < window.innerWidth && 1280 >= window.innerWidth) {
        zoomLevel = this.ImageQualityMedium;
    } else if (1280 < window.innerWidth && 1920 >= window.innerWidth) {
        zoomLevel = this.ImageQualityHigh;
    } else {
        zoomLevel = this.ImageQualitySuperHigh;
    }

    // Limita el zoom al valor máximo permitido
    return Math.min(zoomLevel, maxZoomLevel);
},
